-- DineEasy Database Schema for Supabase
...
-- Insert default admin user (password: starbucks@123)
...
('T001', 2, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT001'),
('T002', 4, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT002'),
('T003', 4, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT003'),
('T004', 6, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT004'),
('T005', 2, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT005'),
('T006', 4, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT006'),
('T007', 8, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT007'),
('T008', 4, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT008'),
('T009', 6, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT009'),
('T010', 2, 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=http%3A//localhost%3A3000/menu%3Ftable%3DT010')
